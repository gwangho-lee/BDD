...
namespace LPMP {
    ...
    template<typename SOLVER>
        void fast_solver(SOLVER& s, const int num_gpus, const size_t max_iter, const double tolerance, const double improvement_slope, const double time_limit, const bool verbose = true)
        {
