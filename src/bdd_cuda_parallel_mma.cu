...
namespace LPMP {
    ...
    template<typename REAL>
        void bdd_cuda_parallel_mma<REAL>::iteration(const size_t max_iter, const double lb_initial, const REAL omega)
        {
            REAL* delta_lo_hi_;
    ...
    template<typename REAL>
        void bdd_cuda_parallel_mma<REAL>::fast_forward_mm(const REAL omega, REAL* delta_lo_hi)
        {
    ...
    template<typename REAL>
        void bdd_cuda_parallel_mma<REAL>::fast_backward_mm(const REAL omega, REAL* delta_lo_hi)
        {
    ...
    template<typename REAL>
        void bdd_cuda_parallel_mma<REAL>::fast_compute_delta(
    ...
    template<typename REAL>
        void bdd_cuda_parallel_mma<REAL>::fast_normalize_delta(REAL* delta_lo_hi) const
        {
            //assert(delta_lo_hi.size() == 2 * this->nr_variables());
